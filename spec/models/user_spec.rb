...
describe "User" do 
	before { @user = User.new(name: "Vasiliy", email: "vasim@railstutorial.org", password: "foobar", password_confirmation: "foobar") }
	subject { @user }
	...
	describe "microposts assotiations " do
		before { @user.save }
		...
		it "should destroy assotiated microposts" do
